        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 text-gray-300">
              <p>AIO Consulting ist ein Projekt der <a href="https://www.phobo.de" target="_blank" rel="noopener noreferrer" className="text-white hover:underline">www.phobo.de</a></p>
            </div>
          </div>
