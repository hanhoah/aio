...
export default function Impressum() {
  ...
  const { company, responsibleForContent, legal: legalInfo } = legal;
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-3xl">
        ...
        <p>
          ...
          <a href={legalInfo.disputeResolution.platform} className="text-primary hover:underline">
            {legalInfo.disputeResolution.platform}
          </a>
          <br />
        ...
        <p className="mt-4">
          {legalInfo.disputeResolution.participate 
